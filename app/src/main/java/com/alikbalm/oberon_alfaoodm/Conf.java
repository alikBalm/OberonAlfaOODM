...
// все эти захардкоренные индексы нужно переместить в отдельный класс типа conf или index
// и уже обращаться в коде по названиям атрибутов экземпляра этого класса а не к числам
// и в случае изменений менять их только в классе
    первый список = 0
    папки документов =  6
    --
    мои документы = 11
    доступно для меня = 12
    общие документы = 13
